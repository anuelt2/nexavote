...
class RegisterViaTokenSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if invitation:
            ...
            if invitation.election_event.role in ['admin', 'staff']:
                raise serializers.ValidationError('Admin and staff cannot register via token.')
        return data
    ...
    def validate_role(self, value):
        ...
        if value not in ['admin', 'staff']:
            raise serializers.ValidationError('Only admin and staff can register directly.')
        return value
